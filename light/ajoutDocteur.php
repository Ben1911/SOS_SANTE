...
// }
$traitementQual = new TraitementFonction();
$listqualite = $traitementQual->getQualite();
                                    ...
                                    <div class="row">
	                                    <div class="col-md-6 col-sm-6">
											...
											<div class="form-group">
	                                            ...
	                                            <input type="text" id="nomComplet" name="nomComplet" class="form-control" placeholder="Enter nom complet">
	                                        </div>
										...
										<div class="form-group">
	                                            <label>Email</label>
	                                            <input type="email"  id="email" name="email" class="form-control" placeholder="Enter l'adresse mail">
	                                        </div>
											<div class="form-group">
	                                            <label>Address</label>
	                                            <input type="text" id="adresse" name="adresse" class="form-control" placeholder="Enter l'adresse">
	                                        </div>
										
											<div class="form-group">
												<label>Profile du medecin</label>
                                                <div class="compose-editor">
                                                  <input type="file" name="profil" id="profil" class="form-control" multiple>
                                                </div>
											</div>
											<div class="form-group">
                 ...
                 || $('#email').val()=='' || $('#phone').val()=='') {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#messages').html(data).addClass('alert alert-success').show();
