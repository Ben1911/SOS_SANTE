...
$listeMalade= $traitement->getAllMaladeById($_GET['idMalade']);
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Modification Malade</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index-2.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Malade</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Modification malade </li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Les Information de malade</header>
								...
								<p id="message"></p>	
                                <?php  foreach ($listeMalade as $mad) : ?>
                                    ...
                                    <div class="row">
	                                    <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
												...
												<input type="hidden" name="id" name="id" value="<?= $mad->getId(); ?>">
	                                            <input type="text" id="nomComplet" name="nomComplet"  value="<?= $mad->getNomComplet(); ?>"  class="form-control" placeholder="Enter nom complet">
	                                        </div>
											<div class="form-group">
	                                            <label>Téléphone</label>
	                                            <input type="text" id="phone" name="phone" value="<?= $mad->getPhone(); ?>" class="form-control" placeholder="Enter numèro de Téléphone">
	                                        </div>                                   
	                                        <!-- select -->
	                                        <div class="form-group">
	                                            <label>Sexe</label>
	                                            <select class="form-control" id="sexe" name="sexe" >
												   <option value="<?= $mad->getSexe(); ?>"><?= $mad->getSexe();?></option>
                                        ...
                                        <div class="form-group">
	                                            ...
	                                            <input type="text" id="nationalite" name="nationalite"  value="<?= $mad->getNationalite(); ?>" class="form-control" placeholder="Enter la nationalité">
	                                        </div>
                                        <div class="form-group">
	                                            <label>Province</label>
	                                            <input type="text"  id="province" name="province" value="<?= $mad->getProvince(); ?>" class="form-control" placeholder="Enter le nom de la province">
	                                        </div>
											<div class="form-group">
	                                            <label>Address</label>
	                                            <input type="text" id="adresse" name="adresse" value="<?= $mad->getAdresse(); ?>" class="form-control" placeholder="Enter l'adresse">
	                                        </div>
...
<script>
        $(function() {
            $('#form-data').on('submit', function(e) {
                e.preventDefault();
                if ($('#nom_complet').val() == '' || $('#sexe').val() == ''
                 || $('#adress').val()=='' 
                 || $('#nationalite').val()=='' || $('#province').val()=='') {
                    $('#message').html('Aucune case n\'est doit restée vide!').addClass('alert alert-danger');
                    $('#messages').html('Aucune case n\'est doit restée vide!').addClass('alert alert-danger');
                } else {
                    $.ajax({
