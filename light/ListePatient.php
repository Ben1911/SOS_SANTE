...
// }
$traitementMalade = new TraitementFonction();
$Listmalade = $traitementMalade->getMalade();
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Formulaire Patients</div>
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="tabbable-line">
                                <ul class="nav nav-pills nav-pills-rose">
									<li class="nav-item tab-all"><a class="nav-link active show"
										href="#tab1" data-toggle="tab">List patients</a></li>
									<li class="nav-item tab-all"><a class="nav-link" href="#tab2"
										data-toggle="tab"> + Ajout patient</a></li>
								</ul>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Ajout des patients</header>
								  ...
								  <div class="row">
	                                    <div class="col-md-6 col-sm-6">
	                                        ...
	                                        <div class="form-group">
	                                            ...
	                                            <input type="text" id="nom_complet" name="nom_complet" class="form-control" placeholder="Enter nom complet">
	                                        </div>
											<div class="form-group">
	                                            <label>Téléphone</label>
	                                            <input type="text" id="phone" name="phone" class="form-control" placeholder="Enter numèro de Téléphone">
	                                        </div>                                   
	                                        <!-- select -->
	                                        <div class="form-group">
	                                            <label>Sexe</label>
											...
											<div class="form-group">
	                                            ...
	                                            <input type="text" id="nationalite" name="nationalite" class="form-control" placeholder="Enter la nationalité">
	                                        </div>
	                                    ...
	                                    <div class="col-md-6 col-sm-6">
											...
											<div class="form-group">
	                                            ...
	                                            <input type="text"  id="province" name="province" class="form-control" placeholder="Enter le nom de la province">
	                                        </div>
											<div class="form-group">
	                                            <label>Address</label>
	                                            <input type="text" id="adress" name="adress" class="form-control" placeholder="Enter l'adresse">
	                                        </div>
										<div class="form-group">
										<label>Profile du malade</label>
