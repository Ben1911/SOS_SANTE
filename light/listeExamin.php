                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Formulaire examin</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index-2.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Examin</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Examin</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="tabbable-line">
                                <ul class="nav nav-pills nav-pills-rose">
									<li class="nav-item tab-all"><a class="nav-link active show"
										href="#tab1" data-toggle="tab">Liste Examin</a></li>
                            ...
                            <div class="card card-box">
								...
								<form id="form-data1" name="contact-form" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
											...
											<label for="simpleFormEmail">Malade</label>
                                            <input type="text" class="form-control" id="idMalade"  name="idMalade" placeholder="Enter le designation de zone de santé">
						...
						<div class="card card-box">
                                <div class="card-head">
                                    <header>Ajout type  examen</header>   
                                </div>
                                <div class="card-body " id="bar-parent">
								<p id="reponse"></p>
								<form id="form-data2" name="contact-form" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="simpleFormEmail">Designation examen</label>
											<input  hidden="true" name="action" type="text" value="insertion">  
											<input type="hidden" name="connection" value="connection">
