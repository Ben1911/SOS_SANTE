		...
		<div class="container-login100 page-background">
			<div class="wrap-login100">
				...
				<p id="message"></p>
					...
					<span class="login100-form-title p-b-34 p-t-18">
						Création de compte
					</span>
					<div class="wrap-input100 validate-input" data-validate = "Enter le nom d'utilisateur">
					<input type="hidden" name="connection" value="connection">
						<input class="input100" type="text" id="nomuser" name="nomuser" placeholder="Enter le nom d'utilisateur">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
                    <div class="wrap-input100 validate-input" data-validate = "Enter vote mail">					
						<input class="input100" type="text" id="email" name="email" placeholder="Enter votre adresse mail">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter le mot de passe">
						<input class="input100" type="password" id="pswd" name="pswd" placeholder="Entrer le mot de passe">
						<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>
