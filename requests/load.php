...
if (empty($_POST['product']) &&  empty($_POST['date1']) &&  empty($_POST['date2'])) {
    echo '<script>window.alert("Aucune case ne doit rester vide."); </script>';
} else {
    $liste_vInfo = $productManager->load_vInfoMarche($_POST['product'], $_POST['marche'], $_POST['date1'], $_POST['date2']);
}
